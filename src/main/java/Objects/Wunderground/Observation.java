...
public class Observation {
    private Date _date;
    private String _tempm;
    private String _dewpti;
    private String _hum;
    private String _wspdm;
    private String _wgustm;
    private String _wdird;
    private String _wdire;
    private String _vism;
    private String _pressurem;
